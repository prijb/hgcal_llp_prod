...
# with command line options: --python_filename TSG-Phase2Spring23DIGIRECOMiniAOD-00152_2_cfg.py --eventcontent MINIAODSIM --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-DIGI-RAW-MINIAOD --inputCommands "keep *" --fileout file:output_miniaod.root --conditions 131X_mcRun4_realistic_v9 --customise_commands "process.MINIAODSIMoutput.outputCommands.append('keep *_*_*_HLT'); process.MINIAODSIMoutput.outputCommands.append('keep *_*_*_SIM');" --step RAW2DIGI,RECO,RECOSIM,PAT --geometry Extended2026D95 --nStreams 3 --filein file:TSG-Phase2Spring23DIGIRECOMiniAOD-00152_0.root --era Phase2C17I13M9 --no_exec --mc -n 100
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:TSG-Phase2Spring23DIGIRECOMiniAOD-00152_0.root'),
